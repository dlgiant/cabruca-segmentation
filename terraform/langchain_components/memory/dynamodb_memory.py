...
class DynamoDBChatMemory(BaseChatMemory):
    ...
    def _load_history(self):
        ...
        try:
            ...
            logger.info(
                f"Loaded {len(messages)} messages from DynamoDB for session {self.session_id}"
            )
    ...
    def _save_message(
        self, message_type: str, content: str, timestamp: datetime, ttl: int
    ):
    ...
    def _trim_messages(self):
        ...
        try:
            ...
            if count > self.max_messages:
                ...
                logger.info(
                    f"Trimmed {messages_to_delete} old messages for session {self.session_id}"
                )
    ...
    def get_session_summary(self, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            duration = self._calculate_duration(
                first_message.get("timestamp"), last_message.get("timestamp")
            )
            ...
            return {
                ...
                "agents_involved": list(
                    set(m.get("agent_name", "unknown") for m in messages)
                ),
        ...
        try:
            ...
            return {
                ...
                "average_messages_per_session": (
                    len(messages) / len(sessions) if sessions else 0
                ),
    ...
    def _extract_decision_text(self, content: str) -> str:
        ...
        for sentence in sentences:
            if any(
                ...
                for kw in ["recommend", "suggest", "should", "will"]
            ):
        ...
        try:
            ...
            response = dynamodb_client.create_table(
                ...
                Tags=[
                    ...
                    {"Key": "Purpose", "Value": "agent-memory"},
                ],
            )
...
# Export classes
__all__ = ["DynamoDBChatMemory", "ConversationAnalyzer", "MemoryTableCreator"]
