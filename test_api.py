...
def test_api():
    ...
    try:
        ...
        result = client.process_image(
            test_image, confidence_threshold=0.5, tile_size=256
        )
    ...
    if Path(plantation_data_path).exists():
        ...
        try:
            comparison = client.compare_with_plantation(
                test_image, plantation_data_path, distance_threshold=2.0
            )
    ...
    try:
        ...
        batch_result = client.process_batch(
            test_images, output_format="json", generate_report=False
        )
