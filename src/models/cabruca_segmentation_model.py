...
class CabrucaSegmentationModel(nn.Module):
    ...
    def __init__(self, num_instance_classes=3, num_semantic_classes=6, 
                 use_sam=False, sam_checkpoint=None):
        """
        ...
        self.instance_head.roi_heads.box_predictor = self._get_instance_predictor(num_instance_classes)
    ...
    def _get_instance_predictor(self, num_classes):
        ...
        # Mask predictor
        in_features_mask = self.instance_head.roi_heads.mask_predictor.conv5_mask.in_channels
        hidden_layer = 256
    ...
    def _extract_fusion_features(self, images):
        ...
        features = F.interpolate(images, size=(images.shape[2]//4, images.shape[3]//4))
...
class CabrucaLoss(nn.Module):
    ...
    def __init__(self, instance_weight=1.0, semantic_weight=1.0, 
                 crown_weight=0.5, density_weight=0.5):
        super().__init__()
