...
def test_sam_import():
    ...
    try:
        from src.models.sam_model import SAMConfig, SAMTreeSegmenter, TreePromptEngineering
...
def test_prompt_engineering():
    ...
    try:
        ...
        cacao_points = prompt_engineer.generate_point_prompts(dummy_image, tree_type='cacao')
        shade_points = prompt_engineer.generate_point_prompts(dummy_image, tree_type='shade')
...
def main():
    ...
    if all_passed:
        ...
        print("2. Test segmentation: python run_sam_segmentation.py --image <your_image.jpg>")
    else:
