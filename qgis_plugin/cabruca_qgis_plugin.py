...
from qgis.core import (QgsProject, QgsVectorLayer, QgsRasterLayer, 
                      ...
                      QgsPointXY, QgsWkbTypes, QgsFields,
                      QgsVectorFileWriter, QgsCoordinateReferenceSystem,
                      QgsProcessingException, QgsRasterBandStats,
...
class CabrucaSegmentationDialog(QDialog):
    ...
    def run_analysis(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Success", 
                                   "Cabruca segmentation completed successfully!")
            self.accept()
    ...
    def load_results_to_qgis(self, results):
        ...
        if 'geojson_path' in results:
            vector_layer = QgsVectorLayer(results['geojson_path'], 
                                        "Cabruca Trees", "ogr")
    ...
    def display_metrics(self, metrics):
        ...
        metrics_text += f"  Average Diameter: {metrics.get('avg_crown_diameter', 0):.2f} m\n"
        metrics_text += f"  Maximum Diameter: {metrics.get('max_crown_diameter', 0):.2f} m\n"
        metrics_text += f"  Minimum Diameter: {metrics.get('min_crown_diameter', 0):.2f} m\n\n"
        ...
        for class_name in ['cacao_tree', 'shade_tree', 'understory', 'bare_soil', 'shadows']:
            ...
            metrics_text += f"  {class_name.replace('_', ' ').title()}: {coverage:.1%}\n"
...
class CabrucaSegmentationAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        """Short help string."""
        return self.tr("Perform multi-class segmentation analysis on Cabruca "
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        output_path = self.parameterAsOutputLayer(parameters, self.OUTPUT_VECTOR, context)
