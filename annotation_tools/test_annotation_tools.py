...
def main():
    ...
    if passed == total:
        ...
        logger.info("\nNext steps:")
        logger.info("1. Launch Streamlit app: streamlit run annotation_tools/streamlit_app/annotation_app.py")
        logger.info("2. Run annotation pipeline: python annotation_tools/annotation_pipeline.py --help")
        ...
        logger.info("2. Install SAM: pip install git+https://github.com/facebookresearch/segment-anything.git")
